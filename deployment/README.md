...
offckb deploy --network devnet --target <contract-binary-path> --output C:\Users\user\my-ckb-project/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output C:\Users\user\my-ckb-project/deployment
```
